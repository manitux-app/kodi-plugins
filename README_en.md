...
After installing this zip file in Kodi using `Install from zip file`, plugins can be installed from the `Manitux Repository`.

## Short Code Installer

Installer plugin zip:
